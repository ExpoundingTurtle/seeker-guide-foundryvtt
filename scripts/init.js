(() => {
  const adventureName = 'The Seeker\'s Guide to the Sunward Isles';
  const moduleName = 'the-seekers-guide-to-the-sunward-isles';
   ...
   */
  const additionalModulePacks = ["the-seekers-guide-to-the-sunward-isles"];
